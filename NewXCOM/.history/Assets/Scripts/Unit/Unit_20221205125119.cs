...
public class Unit : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        MoveAction moveAction = Array.Find(baseActionArray, element => element is MoveAction) as MoveAction;
        moveAction.OnStartMoving += OnAnyUnitMoved;
    ...
    {
        // Lanzamos evento de haber mmovido cualquier nuidad
    }
