...
public class FogOfWarVisual : MonoBehaviour
{
    ...
    {
        foreach (Vector2Int item in collection)
        {
            
        }
        List<GridPosition> list = revealedGridPosition;
        GridSystemVisual.Instance.ShowGridPositionList(revealedGridPosition, GridSystemVisual.GridVisualType.Black);
    }
}
