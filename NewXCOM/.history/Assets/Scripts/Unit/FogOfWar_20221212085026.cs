...
public class FogOfWar : MonoBehaviour
{
    ...
    void UpdateAllFogOfWar()
    {
        ...
        foreach(Unit unit in UnitManager.Instance.GetFriendlyUnitList())
        {
            ...
            float viewDistanceShootingRange = unit.gameObject.GetComponent<ShootAction>().GetMaxShootDistance();
            ...
            for(float angle = 0; angle < 360; angle += angleIncrease)
            {
                ...
                float viewDistanceCollision = viewDistanceShootingRange == null? viewDistanceShootingRange : viewDistanceMax;
